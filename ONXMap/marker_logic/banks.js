...
function addBanks(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('banks', banks, {
        ...
        sidebar_icon_html: '<i class="fas fa-piggy-bank"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon(feature.icon ? feature.icon : 'fa-piggy-bank', 'green'),
                riseOnHover: true
            });
        }
    });
