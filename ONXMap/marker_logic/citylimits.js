...
function addCitylimits(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('citylimits', citylimits, {
        ...
        polygon_style: function (feature) {
            return {
                color: feature.fillColor ? feature.fillColor : 'yellow',
                opacity: 0.05
            };
        },
        ...
        polygon_style_highlight: function (feature) {
            return {
                color: feature.fillColor ? feature.fillColor : 'yellow',
                opacity: 0.5,
                fillColor: feature.fillColor ? feature.fillColor : 'yellow',
                fillOpacity: 0.05
            };
        },
        ...
        sidebar_icon_html: '<i class="fas fa-city"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-city', 'brown'),
                riseOnHover: true
            });
        }
    });
