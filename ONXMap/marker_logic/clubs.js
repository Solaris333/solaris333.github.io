...
function addClubs(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('clubs', clubs, {
        ...
        sidebar_icon_html: '<i class="fas fa-martini-glass"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-martini-glass', 'gold'),
                riseOnHover: true
            });
        }
    });
