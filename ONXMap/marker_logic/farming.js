...
function addFarming(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('farming', farming, {
        ...
        sidebar_icon_html: '<i class="fas fa-tractor"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-tractor', 'brown'),
                riseOnHover: true
            });
        }
    });
