...
function addHousing(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('housing', housing, {
        ...
        sidebar_icon_html: '<i class="fas fa-building"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-building', 'black'),
                riseOnHover: true
            });
        }
    });
