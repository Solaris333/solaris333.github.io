...
function addJobs(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('jobs', jobs, {
        ...
        sidebar_icon_html: '<i class="fas fa-money-check-dollar"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon(feature.icon ? feature.icon : 'fa-money-check-dollar', 'green'),
                riseOnHover: true
            });
        }
    });
