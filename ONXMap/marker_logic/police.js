...
function addPolice(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('police', police, {
        ...
        sidebar_icon_html: '<i class="fas fa-building-shield"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-building-shield'),
                riseOnHover: true
            });
        }
    });
