...
function addRepair(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('repair', repair, {
        ...
        sidebar_icon_html: '<i class="fas fa-wrench"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-wrench', 'yellow'),
                riseOnHover: true
            });
        }
    });
