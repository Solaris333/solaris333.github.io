...
function addReserve(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('reserve', reserve, {
        ...
        polygon_style: function (feature) {
            return {
                color: feature.fillColor ? feature.fillColor : 'green',
                opacity: 0.4
            };
        },
        ...
        polygon_style_highlight: function (feature) {
            return {
                color: feature.fillColor ? feature.fillColor : 'green',
                opacity: 0.6,
                fillColor: feature.fillColor ? feature.fillColor : 'green',
                fillOpacity: 0.2
            };
        },
        ...
        sidebar_icon_html: '<i class="fas fa-tree"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon('fa-tree', 'green'),
                riseOnHover: true
            });
        }
    });
