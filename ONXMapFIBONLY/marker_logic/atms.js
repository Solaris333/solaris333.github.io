...
function addATMs(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('atms', atms, {
        ...
        sidebar_icon_html: '<i class="fas fa-money-bill-transfer"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon(feature.icon ? feature.icon : 'fa-money-bill-transfer', 'red'),
                riseOnHover: true
            });
        }
    });
