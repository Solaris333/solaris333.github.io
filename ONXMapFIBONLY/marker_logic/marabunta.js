...
function addMarabunta(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('marabunta', marabunta, {
        ...
        sidebar_icon_html: '<i class="fas fa-m"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon(feature.icon ? feature.icon : 'fa-m', 'blue'),
                riseOnHover: true
            });
        }
    });
