...
function addPhones(map) {

    // New layer with id `collectibles` from geoJSON `collectibles`
    let layer = map.addInteractiveLayer('phones', phones, {
        ...
        sidebar_icon_html: '<i class="fas fa-phone"></i>',
        ...
        pointToLayer: function (feature, latlng) {
            ...
            return L.marker(latlng, {
                ...
                icon: Utils.getCustomIcon(feature.icon ? feature.icon : 'fa-phone', 'green'),
                riseOnHover: true
            });
        }
    });
